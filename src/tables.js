...
tableScreen.render(document.querySelector("#knifes"), getAllKnifes, (knife, key) => {
  return `<tr>
        <td>
        ...
        <td class="align-middle text-center">
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div>
              <div class="progress">
                <div class="progress-bar bg-gradient-warning" role="progressbar" aria-valuenow="1" aria-valuemin="0" aria-valuemax="100" style="width: 10%"></div>
              </div>
            </div>
          </div>
        </td>
        <td class="align-middle">
          <button class="btn btn-link text-secondary mb-0 modifier__btn" style="position: relative; overflow: visible">
            ...
            <ul class="modifier__list">
              ...
              <li data-id="${key}"  class="modifier__item">Xóa</li>
            </ul>
          </button>
        </td>
      </tr>`;
